  ...
  <div class="min-h-screen bg-white">
    <header>
      <Popover class="relative bg-white">
        <div class="flex justify-between items-center mx-auto px-4 py-2 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <div class="flex-shrink-0 flex items-center">
              <img class="block h-16 w-auto" src="img/logo/undiscoverme_logo.png" alt="undiscoverme_logo" />
            </div>
            <div class="flex-shrink-0 ml-2 flex items-center">
              <h1 class="text-2xl" id="main_title">Undiscover.me</h1>
            </div>
          </div>
          <div class="-mr-2 -my-2 md:hidden">
            <PopoverButton class="bg-white rounded-md p-2 inline-flex items-center justify-center text-black hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <PopoverGroup as="nav" class="hidden md:flex space-x-10">
            <Popover class="relative" v-slot="{ open }">
              <PopoverButton :class="[open ? 'text-gray-900' : 'text-gray-500', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500']">
                <span class="text-2xl text-black hover:text-gray-500" id="solution">Solutions</span>
                <ChevronDownIcon :class="[open ? 'text-grey-400' : 'text-black', 'ml-2 h-5 w-5 group-hover:text-gray-500']" aria-hidden="true" />
              </PopoverButton>
            ...
            <a v-for="item in navigation" :key="item.name" :href="item.href" class="text-2xl font-medium text-black hover:text-gray-500 justify-center items-center" id="navigation">
              {{ item.name }}
            </a>
    ...
    <footer class="bg-white">
      <div class="mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div class="flex justify-center space-x-6 md:order-2">
          <a v-for="item in socials" :key="item.name" :href="item.href" class="text-black hover:text-gray-500">
        ...
        <div class="mt-8 md:mt-0 md:order-1">
          <a href="https://www.gianlucatiengo.com/">
            <p class="text-center text-black text-2xl hover:text-gray-500" id="copyright">
